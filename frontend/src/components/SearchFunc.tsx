...
// 						</div>
// 					</div>
// 					<div className="self-stretch h-[648px] flex-col justify-start items-start gap-6 flex">
// 						<div className="w-[380px] justify-start items-center gap-3 inline-flex">
...
// 								<div className="text-center text-primary-50 text-sm font-semibold font-['Urbanist'] leading-tight tracking-tight">
// 									Follow
// 								</div>
// 							</div>
// 						</div>
